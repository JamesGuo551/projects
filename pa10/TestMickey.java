...
public class TestMickey extends WindowController {
  ...
  public static void main(String [] args) {
    new Acme.MainFrame(new TestMickey(), 550, 500 );
  }
  ...
  public void begin() {
    try {
      ...
      Text errorMsg2 = new Text( msg2, 25, 235, canvas );
      Text errorMsg3 = new Text( msg3, 25, 270, canvas );
  ...
  public void makeMickey() {
    ...
    // Test Circle ctor for shallow copy (incorrect) vs. deep copy (correct)
    ...
    } else { // must have used == instead of equals().
