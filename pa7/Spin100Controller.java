...
public class Spin100Controller extends WindowController {
  ...
  private static final double LEFT_ARROW_X = 218; //position of arrows
  ...
  private static final int CANVAS_WIDTH = 840; //canvas width
  ...
  private Text tie, p1Wins, p2Wins; 
  private JButton finishOne, restart, finishTwo;
  ...
  Spin100Controller controller = this; //create controller instance
